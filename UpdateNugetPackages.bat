...
dotnet add CefSharp.MinimalExample.Wpf.HwndHost\CefSharp.MinimalExample.Wpf.HwndHost.net472.csproj package CefSharp.Wpf.HwndHost -v %cefsharpversion%
...
dotnet add CefSharp.MinimalExample.Wpf.HwndHost\CefSharp.MinimalExample.Wpf.HwndHost.netcore.csproj package CefSharp.Wpf.HwndHost -v %cefsharpversion%
